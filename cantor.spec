...
Version  : 22.08.2
Release  : 64
URL      : https://download.kde.org/stable/release-service/22.08.2/src/cantor-22.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/cantor-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/cantor-22.08.2.tar.xz.sig
...
%prep
%setup -q -n cantor-22.08.2
cd %{_builddir}/cantor-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665714767
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.22.08.2
