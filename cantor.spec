...
Version  : 23.08.4
Release  : 90
URL      : https://download.kde.org/stable/release-service/23.08.4/src/cantor-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/cantor-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/cantor-23.08.4.tar.xz.sig
...
%prep
%setup -q -n cantor-23.08.4
cd %{_builddir}/cantor-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702955125
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcantorlibs.so.23.08.4
...
/usr/lib64/libcantorlibs.so.23.08.4
