...
Version  : 18.08.3
Release  : 5
URL      : https://github.com/KDE/cantor/archive/v18.08.3.tar.gz
Source0  : https://github.com/KDE/cantor/archive/v18.08.3.tar.gz
...
%package abi
Summary: abi components for the cantor package.
Group: Default

%description abi
abi components for the cantor package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1541688717
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libcantorlibs.so.18.08.3.abi
/usr/share/abi/libcantorlibs.so.18.abi
...
/usr/lib64/libcantorlibs.so.18.08.3
