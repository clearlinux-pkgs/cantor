...
Source0  : https://github.com/KDE/cantor/archive/v18.08.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause GFDL-1.2 GPL-2.0
Requires: cantor-bin
Requires: cantor-lib
Requires: cantor-data
Requires: cantor-license
BuildRequires : R
BuildRequires : R-dev
...
export LANG=C
export SOURCE_DATE_EPOCH=1535739662
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.DOC %{buildroot}/usr/share/doc/cantor/COPYING.DOC
cp cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/doc/cantor/cmake_COPYING-CMAKE-SCRIPTS
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.18
/usr/lib64/libcantorlibs.so.18.08.0
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/cantor/COPYING
/usr/share/doc/cantor/COPYING.DOC
/usr/share/doc/cantor/cmake_COPYING-CMAKE-SCRIPTS
