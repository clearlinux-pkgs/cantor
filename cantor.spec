...
Version  : 18.11.80
Release  : 6
URL      : https://github.com/KDE/cantor/archive/v18.11.80.tar.gz
Source0  : https://github.com/KDE/cantor/archive/v18.11.80.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542511703
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.18.11.80
/usr/lib64/libcantorlibs.so.19
