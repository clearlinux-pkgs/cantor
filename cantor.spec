...
Version  : 22.12.3
Release  : 73
URL      : https://download.kde.org/stable/release-service/22.12.3/src/cantor-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/cantor-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/cantor-22.12.3.tar.xz.sig
...
%prep
%setup -q -n cantor-22.12.3
cd %{_builddir}/cantor-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677785721
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.22.12.3
