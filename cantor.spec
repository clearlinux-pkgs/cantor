...
Version  : 18.12.0
Release  : 8
URL      : https://github.com/KDE/cantor/archive/v18.12.0.tar.gz
Source0  : https://github.com/KDE/cantor/archive/v18.12.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544882232
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.18.12.0
