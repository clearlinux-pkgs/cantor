...
Version  : 18.12.1
Release  : 9
URL      : https://github.com/KDE/cantor/archive/v18.12.1.tar.gz
Source0  : https://github.com/KDE/cantor/archive/v18.12.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547131576
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.18.12.1
