...
Version  : 21.08.2
Release  : 52
URL      : https://download.kde.org/stable/release-service/21.08.2/src/cantor-21.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/cantor-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/cantor-21.08.2.tar.xz.sig
...
%prep
%setup -q -n cantor-21.08.2
cd %{_builddir}/cantor-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634350575
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cantor-21.08.2/COPYING %{buildroot}/usr/share/package-licenses/cantor/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/cantor-21.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/cantor/0c4be15f5177aafffe980ca09c0f4ca6ed741f43
cp %{_builddir}/cantor-21.08.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/cantor/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/cantor-21.08.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/cantor/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/cantor-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/cantor/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/cantor-21.08.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/cantor/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/cantor-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/cantor/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/cantor-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/cantor/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/cantor-21.08.2/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/cantor/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang cantor
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.21.08.2
