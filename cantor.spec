...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/cantor-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/cantor-22.04.2.tar.xz.sig
...
%prep
%setup -q -n cantor-22.04.2
cd %{_builddir}/cantor-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654832428
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cantor-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/cantor/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/cantor-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/cantor/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/cantor-22.04.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/cantor/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/cantor-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/cantor/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/cantor-22.04.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/cantor/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/cantor-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/cantor/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/cantor-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/cantor/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/cantor-22.04.2/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/cantor/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang cantor
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.22.04.2
