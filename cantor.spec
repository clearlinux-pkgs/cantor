...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/cantor-22.08.0.tar.xz
...
%prep
%setup -q -n cantor-22.08.0
cd %{_builddir}/cantor-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661543255
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.22.08.0
