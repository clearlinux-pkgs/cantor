...
%prep
%setup -q -n cantor-23.08.1
cd %{_builddir}/cantor-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695074284
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcantorlibs.so.23.08.1
...
/usr/lib64/libcantorlibs.so.23.08.1
