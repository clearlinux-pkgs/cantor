...
Version  : 22.12.1
Release  : 70
URL      : https://download.kde.org/stable/release-service/22.12.1/src/cantor-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/cantor-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/cantor-22.12.1.tar.xz.sig
...
%prep
%setup -q -n cantor-22.12.1
cd %{_builddir}/cantor-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673292973
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcantorlibs.so.22.12.1
